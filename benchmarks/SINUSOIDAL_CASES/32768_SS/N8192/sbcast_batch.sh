...
export CODE_PATH=/ccs/home/nichols/PROJECTS/OLCF6_BENCHMARK/test-hipfft-dns-benchmark
...
srun -u -N8192 -n65536 -c7 --ntasks-per-gpu=1 --gpu-bind=closest /mnt/bb/$USER/$exec

#export OMP_NUM_THREADS=14
#srun -u -N8192 -n65536 -c14 --ntasks-per-gpu=1 --gpu-bind=closest /mnt/bb/$USER/$exec
